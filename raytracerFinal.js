...
if (typeof(Worker) !== undefined) {
    ...
    function startWorker(workerLocation, outCanvasId, renderPattern=null, x=0, y=0, width=0, height=0, images={},
        ...
        function drawToCanvas(data) {
            ...
            if (sizeNotSet) {
                canvas.width = Math.floor(IMAGE_WIDTH + width);
                canvas.height = Math.floor(IMAGE_HEIGHT + height);
                sizeNotSet = false;
            }
        ...
        w.postMessage({renderPattern:renderPattern, images: images, currentScene});
    }
        ...
        startWorker("./raytracer4Worker3.js", "#raytracer-out-canvas4", 
                {
                    numRows:randomInt(1, 8), numCols:randomInt(1, 8), 
                    pattern:"random"
                }, 0, -1, 0, 0, {earthmap:imageData(earth)}, 8);
    }
